...
const WholesalePartners = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        title="Wholesale Partners | Healios"
        description="Partner with Healios to offer premium gummy vitamins to your customers. Competitive margins, marketing support, and flexible ordering."
