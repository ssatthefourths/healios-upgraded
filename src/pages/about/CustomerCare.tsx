...
const CustomerCare = () => (
  <AboutLayout
    ...
    seoTitle="Customer Care | Healios"
    seoDescription="Contact Healios customer support. We're here to help with orders, products, subscriptions and any questions about your wellness journey."
