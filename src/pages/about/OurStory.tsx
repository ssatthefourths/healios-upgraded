...
const OurStory = () => (
  <AboutLayout
    ...
    seoTitle="Our Story | Healios"
    seoDescription="Discover the story behind Healios. Learn about our mission to make wellness simple, effective and accessible through premium gummy vitamins."
